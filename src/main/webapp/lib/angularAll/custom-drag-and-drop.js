/**
 * Created by blackcaps on 17/8/15.
 */
 ...
 *                      his mouse pointer.
 */
    .directive('customDndDraggable', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
        function($parse,   $timeout,   dndDropEffectWorkaround,   dndDragTypeWorkaround) {
            return function(scope, element, attr) {
                ...
                element.on('dragstart', function(event) {
                    ...
                    event.dataTransfer.setData("Text", angular.toJson(scope.$eval(attr.customDndDraggable)));
 ...
 */
    .directive('customDndList', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
        function($parse,   $timeout,   dndDropEffectWorkaround,   dndDragTypeWorkaround) {
            return function(scope, element, attr) {
                ...
                element.on('drop', function(event) {
                    ...
                    var dropModel = attr.ngDropModel;  // Drop destination object from ng-drop-model
                    //if (!isDropAllowed(event)) return true;
                    ...
                    if (attr.dndDrop) {
                        transferredObject = invokeCallback(attr.dndDrop, event, transferredObject, dropModel);
                    ...
                    var targetArray = scope.$eval(attr.customDndList);
                    scope.$apply(function() {
                 ...
                 */
                function invokeCallback(expression, event, item, dropModel) {
