...
angular.module('app')
    .controller('AppCtrl', [
        '$rootScope', '$localStorage', '$state', '$scope',
        function($rootScope, $localStorage, $state, $scope) {
            /*$scope.path = 'assets/img/favicon.png';
            if(window.location.hostname == 'meratask.fieldrun.in')
                $scope.path = 'assets/img/orgLogo/meratask-logo1.png';*/
            $rootScope.settings = {
                skin: '',
                color: {
                    themeprimary: '#2dc3e8',
